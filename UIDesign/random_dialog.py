...
class Ui_dgRandom(object):
    def setupUi(self, dgRandom):
        ...
        dgRandom.resize(489, 250)
        dgRandom.setMinimumSize(QtCore.QSize(489, 250))
        dgRandom.setMaximumSize(QtCore.QSize(489, 250))
        ...
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.wg_createOption)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.rd_createOption = QtWidgets.QRadioButton(self.wg_createOption)
        self.rd_createOption.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.rd_createOption.setChecked(True)
        self.rd_createOption.setObjectName("rd_createOption")
        self.horizontalLayout_3.addWidget(self.rd_createOption)
