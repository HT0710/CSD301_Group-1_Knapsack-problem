...
class Ui_dgRandom(object):
    def setupUi(self, dgRandom):
        ...
        dgRandom.resize(489, 227)
        dgRandom.setMinimumSize(QtCore.QSize(489, 227))
        dgRandom.setMaximumSize(QtCore.QSize(489, 227))
        ...
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.wg_maxPrice)
        ...
        self.horizontalLayout_3.addWidget(self.lb_maximumPrice)
        ...
        self.horizontalLayout_3.addWidget(self.spb_maximumPrice)
